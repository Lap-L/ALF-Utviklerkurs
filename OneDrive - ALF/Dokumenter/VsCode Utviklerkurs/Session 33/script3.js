...
let lag = [
    ...
    },
    {
        ...
        Nasjonalitet: "Norge",
        Født: "30-01-2005",
        Image: "images/Brann-bortetrøye.webp",
    },
    {
        Nummer: 2,
        Posisjon: "Forsvarsspiller",
    ...
    },
    {
        ...
        function c() { // skriv ut info i stylede "cards" slik at det blir et "produkt-kort" med presentasjon av den enkelte spilleren i hvert slikt kort.
            let result = `<div class="cards-container">`;
            ...
            for (let i = 0; i < lag.length; i++) {
                ...
                if( posisjon !== "alle" && spiller.Posisjon.toLowerCase() !== posisjon) {
                    continue; // hopper over spillere som ikke har valgt posisjon
                }
                result += `<div class="player-card">
                    <div class="image-container"> 
                        <img src=${spiller.Image}>
                    </div>
                    <h1>${spiller.Fornavn} ${spiller.Etternavn} </h1>
                    <h2>${spiller.Posisjon.toUpperCase()} </h2>
                    <p>Nasjonalitet: ${spiller.Nasjonalitet}</p>
                    <hr>
                    <p>Født: ${spiller.Født}</p>
                    <hr>
                    <p>Høyde: ${ (spiller.Høyde)? `${spiller.Høyde}cm` : "Ikke oppgitt"}</p>
                </div>`
            }
            result += `</div>`;
        ...
        function settTekst(){
                document.getElementById("vis").value = `Vis ${document.getElementById("posisjon").value}` 
        }
